...
export default function Motherboard({ Products }) {
  return (
    <>
      <h1 className="flex justify-center text-3xl mt-8">Our Motherboards</h1>
      <div className="grid md:grid-cols-3 grid-cols-1 gap-y-2 mb-16 mt-16">
        {Products.Motherboard.map((item) => (
