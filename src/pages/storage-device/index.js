...
export default function StorageDevice({ Products }) {
  return (
    <>
      <h1 className="flex justify-center text-3xl mt-8">Our Storage</h1>
      <div className="grid md:grid-cols-3 grid-cols-1 gap-y-2 mb-16 mt-16">
        {Products.StorageDevice.map((item) => (
          <div key={item.id} className="card w-96 bg-base-100 shadow-xl">
            ...
            <div className="card-body items-center text-center">
              ...
              <div className="card-actions">
                <Link href={`/storage-device/${item.id}`}>
                  {" "}
